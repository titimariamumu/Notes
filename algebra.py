...
Original file is located at
    ...
    These are based of the College Algebra - Full Course with Python Code by Ed Pratwoski at freecodingcamp.org: https://github.com/edatfreecodecamp/python-math/blob/main/Algebra-with-Python/Algebra-Read-Me-Course-Outline.md
""
